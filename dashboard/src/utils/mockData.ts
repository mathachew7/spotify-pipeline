...
const RAW: RawTrack[] = [
  {
    ...
    plays: [daysAgo(0, 8, 30), daysAgo(0, 14), daysAgo(1, 22), daysAgo(15, 10), daysAgo(55, 16)],
  },
  {
    ...
    plays: [daysAgo(0, 12), daysAgo(1, 9), daysAgo(8, 21), daysAgo(35, 14)],
  },
  {
    ...
    plays: [daysAgo(0, 18), daysAgo(1, 8), daysAgo(5, 13)],
  },
  {
    ...
    plays: [daysAgo(0, 7), daysAgo(0, 23), daysAgo(3, 15), daysAgo(20, 8)],
  },
  {
    ...
    plays: [daysAgo(1, 7, 30), daysAgo(2, 19), daysAgo(12, 12)],
  },
  {
    ...
    plays: [daysAgo(1, 21), daysAgo(2, 13), daysAgo(18, 16)],
  },
  {
    ...
    plays: [daysAgo(2, 23), daysAgo(2, 11), daysAgo(9, 9)],
  },
  {
    ...
    plays: [daysAgo(1, 20), daysAgo(3, 15), daysAgo(6, 10), daysAgo(22, 21)],
  },
  {
    ...
    plays: [daysAgo(4, 17), daysAgo(5, 8), daysAgo(6, 22)],
  },
  {
    ...
    plays: [daysAgo(3, 12), daysAgo(5, 18), daysAgo(45, 7)],
  },
  {
    ...
    plays: [daysAgo(5, 1), daysAgo(6, 23)],
  },
  {
    ...
    plays: [daysAgo(4, 9), daysAgo(6, 17), daysAgo(28, 11)],
  },
  {
    ...
    plays: [daysAgo(8, 13), daysAgo(14, 7, 30), daysAgo(25, 18)],
  },
  {
    ...
    plays: [daysAgo(0, 11), daysAgo(1, 19), daysAgo(4, 8), daysAgo(12, 15), daysAgo(32, 10)],
  },
  {
    id: 'tr_15', name: 'STAY',
    ...
    plays: [daysAgo(9, 16), daysAgo(15, 21), daysAgo(24, 9)],
  },
  {
    ...
    plays: [daysAgo(11, 20), daysAgo(18, 12), daysAgo(27, 17)],
  },
  {
    ...
    plays: [daysAgo(17, 22), daysAgo(24, 10), daysAgo(50, 20)],
  },
  {
    ...
    plays: [daysAgo(16, 14), daysAgo(23, 11)],
  },
  {
    ...
    plays: [daysAgo(10, 10), daysAgo(18, 18), daysAgo(29, 14)],
  },
  {
    ...
    plays: [daysAgo(22, 17), daysAgo(29, 20)],
  },
  {
    ...
    plays: [daysAgo(33, 13), daysAgo(48, 22)],
  },
  {
    id: 'tr_22', name: 'Ghost',
    ...
    plays: [daysAgo(38, 9), daysAgo(60, 22), daysAgo(75, 11)],
  },
  {
    ...
    plays: [daysAgo(40, 0, 30), daysAgo(62, 1), daysAgo(88, 23)],
  },
  {
    id: 'tr_24', name: 'Woman',
    ...
    plays: [daysAgo(55, 19, 30), daysAgo(72, 16)],
  },
  {
    ...
    plays: [daysAgo(65, 21), daysAgo(82, 19)],
  },
  {
    ...
    plays: [daysAgo(95, 12), daysAgo(108, 18)],
  },
  {
    ...
    plays: [daysAgo(102, 11), daysAgo(120, 14)],
  },
  {
    ...
    plays: [daysAgo(112, 14), daysAgo(135, 11)],
  },
  {
    ...
    plays: [daysAgo(125, 18), daysAgo(148, 8)],
  },
  {
    ...
    plays: [daysAgo(155, 23), daysAgo(180, 0)],
  },
]
