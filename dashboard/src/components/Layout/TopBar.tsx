...
export function TopBar({ trackCount, dataMode, onOpenUploader }: TopBarProps) {
  ...
  return (
    <header className="h-12 bg-spotify-dark border-b border-spotify-border flex items-center px-4 gap-4 flex-shrink-0">
      ...
      <div className="flex items-center gap-4 text-xs">
        ...
        <span className="text-spotify-text">
          Range: <span className="text-white font-medium">{filters.timeRange}</span>
        </span>
      </div>
      ...
      <button
        ...
        className="text-xs px-3 py-1.5 bg-spotify-green text-black font-semibold rounded-full hover:bg-green-400 transition-colors"
      >
        Connect data
      </button>
    </header>
